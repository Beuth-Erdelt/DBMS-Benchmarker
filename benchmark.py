...
if __name__ == '__main__':
    ...
    parser.add_argument('-dd', '--discard-data', help='result sets of all queries are discarded (not fetched at all)', action='store_true', default=False)
